...
### 4. (ОПЦИОНАЛЬНО) Послать письмо c pdf отчетом на e-mail (возможно несколько) по номеру заказа
...
### 5. (ОПЦИОНАЛЬНО) Получить конечный JSON по номеру заказа
